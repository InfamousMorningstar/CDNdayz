...
import { Flame, RefreshCw, Calendar, Shield, Database } from 'lucide-react';
    ...
    return (
      <CinematicBackground backgroundImageSrc="/Images/5.jpg">
        <div className="min-h-screen pt-28 sm:pt-32 pb-16 sm:pb-20 container mx-auto px-4 sm:px-6 relative z-10 flex items-center justify-center">
          <div className="text-gray-600 dark:text-neutral-400">Loading wipe information...</div>
        </div>
      </CinematicBackground>
    );
  }
        ...
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Card className="p-5 sm:p-8 bg-white/80 dark:bg-neutral-900/60 border-gray-200 dark:border-neutral-800 backdrop-blur-md">
                ...
                <div className="bg-gray-50 dark:bg-neutral-950/50 p-6 rounded-xl border border-gray-200 dark:border-white/5 flex flex-col items-center text-center">
                    ...
                    <p className="mt-4 text-xs text-gray-400 dark:text-neutral-500 max-w-lg">
                        Dates are estimates. Always check the <span className="text-gray-900 dark:text-white">#announcements</span> channel 
            ...
            {/* The Cycle Card */}
            <Card className="p-5 sm:p-8 bg-white/80 dark:bg-neutral-900/60 border-gray-200 dark:border-neutral-800 backdrop-blur-md relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="space-y-6 text-lg text-gray-600 dark:text-neutral-300 leading-relaxed">
                        <p>
                            To ensure server stability, introduce new content, and keep the economy fresh, 
                            all CDN servers undergo a full wipe approximately <strong className="text-gray-900 dark:text-white">every {wipeDates.wipeCycleMonths} months</strong>.
                        </p>
                        <p>
            ...
            <Card className="p-5 sm:p-8 bg-white/80 dark:bg-neutral-900/60 border-gray-200 dark:border-neutral-800 backdrop-blur-md relative overflow-hidden">
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200 dark:border-emerald-500/20 p-6 rounded-xl mb-6">
                    ...
                    <p className="text-gray-600 dark:text-neutral-300">
                        ...
                        <span className="text-gray-900 dark:text-white font-bold"> last month (30 days) before a scheduled wipe</span>, 
                        your items are safe.
                    </p>
                </div>


                <div className="space-y-4 text-gray-600 dark:text-neutral-300 text-sm">
                    <p>
                        <strong className="text-gray-900 dark:text-white">How it works:</strong>
                        <br />
