              ...
              <section>
                ...
                <div className="bg-neutral-950/50 p-6 rounded-lg border border-neutral-800 mt-4">
                  ...
                  <p className="text-neutral-300">
                    <strong>For Server Issues:</strong> If you have issues with in-game griefing, bans, or donations, please open a ticket in the official <Link href="https://discord.gg/sBPzcjzBcT" className="text-red-400 hover:text-red-300 underline">CDN Discord</Link>.
                  </p>
                </div>
              </section>
