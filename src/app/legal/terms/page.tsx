    ...
    <CinematicBackground>
      <div className="min-h-screen pt-28 sm:pt-32 pb-16 sm:pb-20 container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8">Terms of Service</h1>
          ...
          <Card className="p-5 sm:p-8 md:p-12 bg-white/80 dark:bg-neutral-900/60 border-gray-200 dark:border-neutral-800 backdrop-blur-md">
            <div className="prose dark:prose-invert max-w-none space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">2. Liability Disclaimer</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">4. Contact</h2>
                <div className="bg-gray-50 dark:bg-neutral-950/50 p-6 rounded-lg border border-gray-200 dark:border-neutral-800 mt-4">
