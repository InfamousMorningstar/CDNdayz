      ...
      <div className="min-h-screen pt-28 sm:pt-32 pb-16 sm:pb-20 container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col items-center text-center mb-10 sm:mb-16">
            ...
            <p className="text-gray-600 dark:text-neutral-400 text-base sm:text-lg max-w-2xl">
          ...
          <div className="space-y-8 sm:space-y-12 relative before:absolute before:left-[19px] before:top-4 before:bottom-4 before:w-0.5 before:bg-gradient-to-b before:from-red-500 before:via-red-500/20 before:to-transparent">
            {steps.map((step, index) => (
              <div key={index} className="relative pl-12 md:pl-0 md:grid md:grid-cols-[200px_1fr] md:gap-8 items-start group">
                {/* Timeline dot */}
                <div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-white dark:bg-neutral-900 border-2 border-red-500/50 flex items-center justify-center z-10 shadow-[0_0_20px_rgba(220,38,38,0.2)] md:relative md:left-auto md:top-auto md:w-16 md:h-16 md:mx-auto">
                  <span className="font-mono font-bold text-gray-900 dark:text-white md:text-xl">{index + 1}</span>
                </div>
                
                <Card className="p-5 sm:p-8 bg-white/70 dark:bg-neutral-900/40 border-gray-200 dark:border-neutral-800 hover:border-red-500/30 transition-colors">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                    <div className="flex items-center gap-3">
                      <step.icon className="text-red-500 w-6 h-6" />
                      <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{step.title}</h3>
                    </div>
                    {step.action && (
                  ...
                  <p className="text-gray-600 dark:text-neutral-400 leading-relaxed text-base sm:text-lg mb-4">
                    {step.description}
                  </p>
                </Card>
              </div>
          ...
          <div className="mt-14 sm:mt-20 pt-8 sm:pt-10 border-t border-gray-200 dark:border-white/5 flex flex-col items-center text-center">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Already in?</h3>
              <p className="text-gray-600 dark:text-neutral-400 mb-8 max-w-lg">
