            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <Card className="p-5 bg-red-950/20 border-red-500/30 md:col-span-2">
                  ...
                  <ul className="space-y-2.5 text-sm text-gray-600 dark:text-neutral-300">
                    <li className="flex gap-3 rounded-md border border-red-500/30 bg-red-950/20 px-3 py-2"><span className="text-red-400 shrink-0 font-bold">!</span><span><strong className="text-red-300 uppercase tracking-wide">Death inside is final</strong> — there is <strong className="text-white">no TP back</strong> and <strong className="text-white">no admin assistance</strong>. That is part of the game, so make sure you bring something, <em>wink wink</em>, that can help save your loot.</span></li>
                    <li className="flex gap-2"><span className="text-red-500 shrink-0">›</span><span><strong className="text-gray-900 dark:text-white">One Way In, One Way Out</strong> — entry is through the black door only. Exit is through the red door located somewhere inside the dungeon. It exists, but it is intentionally not obvious.</span></li>
                    <li className="flex gap-2"><span className="text-red-500 shrink-0">›</span><span><strong className="text-gray-900 dark:text-white">Punch Card Required</strong> — you must have a punch card to enter the dungeon.</span></li>
                    <li className="flex gap-2"><span className="text-red-500 shrink-0">›</span><span><strong className="text-gray-900 dark:text-white">One Group At A Time</strong> — only one group may be inside the dungeon at any time. Wait until they are fully out before your group enters.</span></li>
