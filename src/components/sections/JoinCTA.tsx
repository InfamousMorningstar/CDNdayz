...
export function JoinCTA() {
  return (
    <section aria-labelledby="join-cta-heading" className="py-20 sm:py-28 bg-gradient-to-br from-red-50 via-white to-gray-100 dark:from-red-900/10 dark:via-black dark:to-neutral-900/30 text-center relative overflow-hidden">
