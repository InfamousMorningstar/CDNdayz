                ...
                <Card className="h-full bg-white dark:bg-neutral-950/80 border-gray-200 dark:border-neutral-800 p-4 sm:p-6 relative overflow-hidden flex flex-col">
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="mb-4 pb-4 border-b border-gray-100 dark:border-white/5 flex items-center gap-2">
                             ...
                             <div>
                                          <span className="text-[10px] font-mono text-gray-400 dark:text-neutral-400 tracking-widest uppercase block leading-none mb-1">Official Comms</span>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white leading-none">Global Intel</h3>
                             </div>
                        </div>
